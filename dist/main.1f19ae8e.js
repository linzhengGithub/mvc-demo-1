...
$tabBar.on('click', 'li', function (e) {
  var $li = (0, _jquery.default)(e.currentTarget); //点击的是li而不是里面的span

  $li.addClass('selected').siblings().removeClass('selected'); //找到li，再li上面添加selected，再找到他的兄弟元素，移除selected

  var index = $li.index(); //被点击的li是第几个

  $tabContent.children().eq(index).addClass('active').siblings().removeClass('active'); //找到它的儿子元素，第index个添加active，找到他的兄弟元素，移除active
});
